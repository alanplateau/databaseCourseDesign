...
<!-- Navigation-->
<%
    String mess = (String) session.getAttribute("ChangePassMessage");
...
<% session.setAttribute("ChangePassMessage", "");
}%>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <div>
            <form action="/manage/changeTeacherPass" method="post">
                新密码&nbsp<input type="password" name="password" class="form-control"><br>
                再次输入 <input type="password" name="SurePassword" class="form-control"><br>
